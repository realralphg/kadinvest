    ...
    <q-dialog full-width v-model="speakerDialog">
      <q-card style="height: 500px; width: 100%" class="dialog_wid">
        <div class="delp row">
          ...
          <!-- <q-separator /> -->
          <div class="col-md-6 q-pa-md col-sm-12 col-xs-12">
...
export default {
      ...
      speakers: [
        {
          ...
          profile:
            "Name: Mr. Alok Gupta is the Managing Director African Industries Group  who's the leading corporation in Mining, Metals, Power, Chemicals,Consumer Durables, Logistics, Decoratives, Farming, Research and Development, Engineering Products and Packaging. Mr. Alok Gupta is the Managing Director of African Industries Group, a diversified conglomerate headquartered in Nigeria. Mr. Alok currently spearheads the group’s manufacturing efforts. It is under his stewardship and guidance that the group’s manufacturing strategy has been successfully implemented. The Group’s steel manufacturing capacity has increased multi fold in less than a decade. Under his leadership the group continues to expand through several Greenfield, and Brownfield projects. He is currently at the helm of commissioning the group’s most ambitious project of a fully integrated iron ore mining and processing plant in Kaduna state, Nigeria. This project is one of Nigeria's largest non-oil FDI investment and will help in the socio-economic development of host communities along with generating employment opportunities for locals. The project will also position Nigeria as a prominent Global producer of crude Steel. His vision is to establish the group as a partner of choice for customers and be recognized as an employer of choice.",
        },
        {
  ...
  methods: {
    toggleBio(speakerMember) {
      this.speakerDialog = true;
      this.profile = speakerMember;
    },
  },
};
</script>
...
figure.effect-sadie:hover h2 {
  color: #fff;
  -webkit-transform: translate3d(0, -280%, 0) translate3d(0, -40px, 0);
  transform: translate3d(0, -280%, 0) translate3d(0, -40px, 0);
  background: none;
}
