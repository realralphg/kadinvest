<template>
  <div class="count_wrapper">
    ...
    >
      <iframe
        src="https://giphy.com/embed/IsCM8aCBUjpRwJ2IJN"
        width="100%"
        height="100%"
    ...
    <header class="heading">
      <div class="">
        ...
        <!-- <h2 class="about">to the Metaverse</h2> -->
      </div>
    </header>
    <!-- <div class="container">
      <div class="" data-text="Welcome to the Metaverse"></div>
    </div> -->
    <div class="count_hold">
      <div class="auto_grid">
        <div class="card">
          <p>
            Enter KADINVEST 7.0 <br />
            Main Summit
          </p>
          ...
          <a
            target="_blank"
            href="https://spatial.io/s/KADINVEST-Main-Summit-63402dd8e290f80001a1bce5?share=192474115220888067"
