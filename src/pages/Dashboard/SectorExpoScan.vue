...
export default {
  ...
  methods: {
    ...
    getStats() {
      this.$api
        .get(
          "manage/form-data/stats/4?data=type:summit,type:sector_expo,type:summit.sector_expo,attending_via:Metaverse,attending_via:Physical,attending_via:Virtual"
        )
        .then((response) => {
